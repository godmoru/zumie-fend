export const arabic = {
  ...
  "Welcome to Zumie!": "ي 6 صباحًا مارت",
  ...
  "Register as seller and open shop in Zumie to start your business":
    "سجل كبائع ومتجر مفتوح في Zumie لبدء عملك",
  ...
  eBusiness: "Ebusiness",
  Solution: "حل",
  "Zumie is a Laravel and Flutter Framework-based multi-vendor food, grocery, eCommerce, parcel, and pharmacy delivery system. It has six modules to cover all your business functionality.":
    "Zumie عبارة عن نظام توصيل متعدد البائعين ، والبقالة ، والتجارة الإلكترونية ، والتجارة الإلكترونية ، والتجارة الإلكترونية ، والطرز ، ونظام توصيل الصيدلة ، Zumie عبارة عن نظام توصيل الصيدلة ، وتجارة الإلكترون ، والتجارة الإلكترونية ، والطرد ، ونظام توصيل الصيدلة. لديها ست وحدات لتغطية جميع وظائف عملك.",
  ...
  "They create a account on Zumie using your code and place their first order":
    "يقومون بإنشاء حساب على Zumie باستخدام الكود الخاص بك ويضعون طلبهم الأول",
